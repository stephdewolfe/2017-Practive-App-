...
class VetsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create vet" do
    assert_difference('Vet.count') do
      post vets_url, params: { vet: { clinic: @vet.clinic, doctor: @vet.doctor, fax: @vet.fax, phone: @vet.phone } }
    end
  ...
  test "should update vet" do
    patch vet_url(@vet), params: { vet: { clinic: @vet.clinic, doctor: @vet.doctor, fax: @vet.fax, phone: @vet.phone } }
